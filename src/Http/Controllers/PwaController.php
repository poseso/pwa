                ...
                caches.open(staticCacheName)
                    .then(cache => {
                        return cache.addAll([
                            ...
                            '{$base_url}/demo1/plugins/global/plugins.bundle.js',
                            '{$base_url}/demo1/js/scripts.bundle.js',
                            '{$base_url}/demo1/plugins/custom/fullcalendar/fullcalendar.bundle.js',
                            '{$base_url}/demo1/plugins/custom/datatables/datatables.bundle.js',
